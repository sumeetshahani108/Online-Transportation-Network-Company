...
function check(){
	...
	var myNum1 = +b; 
	if (isNaN(myNum)) {
		document.getElementById("err").innerHTML = 'Please input a valid latitude';
		return false;
	} 
	if (isNaN(myNum1)) {
		document.getElementById("err").innerHTML = 'Please input a valid longitude';
		return false;
	} 
		return true;
...
<s:form action="locationRegister" onSubmit="return check();">
	<s:textfield label="Latitude" key="latitude" id="lat"/>
	<s:textfield label="Longitude" key="longitude" id="lon"/>
	<s:submit /> 
</s:form>
