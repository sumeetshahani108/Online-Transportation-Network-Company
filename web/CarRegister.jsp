...
<s:form action="carRegister">
	<s:textfield label="Model" key="car_model" />
	<s:textfield label="Brand" key="car_brand" />
	<s:textfield label="Category" key="car_category" />
	<s:textfield label="Image" key="image" />
	<s:submit /> 
</s:form>
</body>
</html>